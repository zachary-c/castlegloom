...
export default function Home() {
  return (
    <main>
        <h1>Castle Gloom</h1>
        <p>With the success of my first domain (spook-tober.com) and the project it hosted, I found myself in pursuit of a new domain. There were three basic criteria for this domain:</p>
        <ol>
        ...
        <p>
            ...
            One strong candidate for a time was hyperionactual.com -- which while potentially difficult to spell would be two common words, and a <a href="https://www.youtube.com/watch?v=haMc_eebx9o">Starcraft voice line</a>.   
        </p>
        <p>
            However, when I came across the ancestral home of the clan, Castle Campbell, and <a href="https://en.wikipedia.org/wiki/Castle_Campbell">learned it to have once been called Castle Gloom</a> (or Castle Glume, as some
