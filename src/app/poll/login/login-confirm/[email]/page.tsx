...
export default function LoginConfirm({ params } : { params : { email : string }}) {
    return <div className="login__confirm">
        ...
        <p>If you don't receive an email, please confirm you entered the correct email address and <a href="/poll/login">try again</a>. If the issue persists, please send us an email at <a href="mailto:314oracle@gmail.com">314oracle@gmail.com</a>.</p>
    </div>
}