...
export function generatePollHTML(question: PollQuestion_t, recipient: Recipient_t, obj: ThemeObject): string {
 ...
 ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏  ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏  ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏  ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏  ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏  ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏  ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏  ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏  ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏  ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏  ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏  ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏  ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏  ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏  ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏  ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏ ͏          
		...
		${(question.edict && generateEdictInnerHtml(question.edict, recipient, edictThemeObject(question.edict.colorscheme))) ?? ""}
...
function injectParams(body: string, recipient: Recipient_t): string {
  return body.replaceAll("$$USERID$$", recipient._id)
}

export function generateEdictInnerHtml(edict: KingsEdict_t, recipient: Recipient_t, themeObj: EdictThemeObject) {
  const htmlBody = toHTML(edict.edictBody ?? [])
  const styledHTML = applyStyleToHtml(htmlBody, `color:${themeObj.a_color};`, "", "font-size: 1.15rem")
  const postProcessedContent = injectParams(styledHTML, recipient)
